...
<body>
  ...
  <select class="changeFilter">
    <option value="">All</option>
    <option value="generic-feedback-v2.0">generic-feedback-v2.0</option>
    <option value="open-edx-virtual-labs-v2.0_for_experiment">open-edx-virtual-labs-v2.0_for_experiment</option>
    <option value="open-edx-virtual-labs-v2.0_for_lab">open-edx-virtual-labs-v2.0_for_lab</option>
    <option value="generic-exp-feedback-v2.0"> generic-exp-feedback-v2.0</option>
  </select>
...
#+BEGIN_SRC  javascript :tangle /static/js/chart_display.js :eval no :noweb yes
  ...
  function filterSelect() {
    ...
    var dict = {}
    var gap = 50
    var test1='generic-feedback-v2.0'
    ...
    $.ajax({// Ajax call for URL
      ...
      .done(function (data/*this is the data or response*/) {
        ...
        console.log(dataSet["hits"]["hits"].length)
       
        for (var index1 = 0; index1 < dataSet["hits"]["hits"].length; index1++) {  //  iterates through first lebel
          var year;
          if(dataSet.hits.hits[index1]._source.version==$('.changeFilter').val()||$('.changeFilter').val()=='')
           {
          console.log(dataSet.hits.hits[index1]._source.version)
