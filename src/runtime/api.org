...
<body>
  <div class="centerssss"><i class="fa fa-spinner" aria-hidden="true"></i></div>
<div class = "main">
<div class="top">
</div>
<div class="row">
<div class="col-sm-3 parts part1"><p>Total number of lab feedbacks</p><div><i class="fa fa-line-chart" aria-hidden="true"></i> 1500</div> </div>
<div class="col-sm-3 parts part2"><p>Total number of generic feedbacks</p><div><i class="fa fa-line-chart" aria-hidden="true"></i> 1500</div></div>
<div class="col-sm-3 parts part3"><p>Total number of Experiment feedbacks</p><div><i class="fa fa-line-chart" aria-hidden="true"></i> 1500</div></div>
<div class="col-sm-2 parts part4"><p>Total number of feedbacks</p><div><i class="fa fa-line-chart" aria-hidden="true"></i> 1500</div></div>
</div>
<div id='dashboard' class="bottom">
  <div id="fillgaugeContainer">
    
  <svg id="fillgauge1" width="100%" height="230"></svg>
  </div>
</div>
</div>
<script src="http://d3js.org/d3.v3.min.js"></script>
<script src="https://code.jquery.com/jquery-3.2.1.min.js"></script>
<script src="../static/js/piecharts.js"></script>
#+END_SRC
...
body{
    ...
    height: 100%;
    margin:0px auto;
    background: -moz-linear-gradient(313deg, rgba(153,218,255,1) 0%, #08A3A3 100%) no-repeat center center fixed; ; /* ff3.6+ */
    background: -webkit-gradient(linear, left top, right bottom, color-stop(0%, rgba(153,218,255,1)), color-stop(100%, #08A3A3)) no-repeat center center fixed; ; /* safari4+,chrome */
    background: -webkit-linear-gradient(313deg, rgba(153,218,255,1) 0%, #08A3A3 100%) no-repeat center center fixed; ; /* safari5.1+,chrome10+ */
    background: -o-linear-gradient(313deg, rgba(153,218,255,1) 0%, #08A3A3 100%) no-repeat center center fixed ; /* opera 11.10+ */
    background: -ms-linear-gradient(313deg, rgba(153,218,255,1) 0%, #08A3A3 100%) ; /* ie10+ */
    background: linear-gradient(137deg, rgba(153,218,255,1) 0%, #08A3A3 100%); /* w3c */
...
#fillgaugeContainer,#firstPieChart,#secondPieChart,#barChartExample{
  background: rgba(255,255,255,0.4);
}
#barChartExample p,#firstPieChart p,#secondPieChart p{
  background: #1b1717cc;
  margin-top: 0;
  text-align: center;
  font-size: 20px;
