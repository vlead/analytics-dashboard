...
** Index HTML
#+BEGIN_SRC  html :tangle ../runtime/web/templates/index.html :eval no :noweb yes
<html>
  <head>
    <title> dashboard </title>
    <link href = "../web/rest/static/css/tab.css" rel = "stylesheet" type="text/css">
    <script src="../web/rest/static/js/chart_display.js"></script>
  ...
  var saveData = $.ajax({
      type: "POST",
      url: "http://10.4.12.46/vlabs/feedback/_search",
      data: {
   "query" : { "query_string" : {"query" : "*"} },
   "facets" : {
     "tags" : { "terms" : {"field" : "version"} }
   }
 },
       dataType: "json",
       
       success: function(resultData, textStatus) { alert("Save Complete") }
       });
...
** JS
#+BEGIN_SRC  javascript :tangle ../runtime/web/static/js/chart_display.js :eval no :noweb yes
...
** CSS 
#+BEGIN_SRC  css :tangle ../runtime/web/static/css/tab.css
body {
