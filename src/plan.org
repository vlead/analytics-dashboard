...
|     |                     |        | hours)    | hours) |            |            |          |           |
|-----+---------------------+--------+-----------+--------+------------+------------+----------+-----------|
|  1. | Display total       | [[https://github.com/vlead/analytics-dashboard/issues/22][#22]]    |           |        |            |            | Done     | Mrudhvika |
|     | number of feedbacks |        |           |        |            |            |          |           |
|     | on the top          |        |           |        |            |            |          |           |
|     |                     |        |           |        |            |            |          |           |
|-----+---------------------+--------+-----------+--------+------------+------------+----------+-----------|
|  2. | Dynamically display | [[https://github.com/vlead/analytics-dashboard/issues/23][#23]]    |           |        |            |            | Done     | Mrudhvika |
|     | feedbacks yearly    |        |           |        |            |            |          | Reena     |
|     | wise                |        |           |        |            |            |          |           |
|-----+---------------------+--------+-----------+--------+------------+------------+----------+-----------|
